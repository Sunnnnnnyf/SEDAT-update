...
class OARO(object):
    ...
    def design(self):
        ...
        self.brine_salinity = self.FeedC_r / (1 - int(recrate)/100)
        self.brine_flow_rate = self.Capacity * (1 - int(recrate)/100)
        self.design_output = []
        ...
        self.design_output.append({'Name':'Brine concentration','Value':self.brine_salinity,'Unit':'g/L'})
