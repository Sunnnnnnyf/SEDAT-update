...
class lt_med_general(object):
    ...
    def design(self):
        ...
        self.brine_salinity = self.Xf / (1 - self.RR) / 1000
        self.brine_flow_rate = self.Capacity * (1 - self.RR)
...
#        design_output.append({'Name':'Permeate flow rate','Value': self.F * self.num_modules,'Unit':'l/h'})    
    ...
    def simulation(self, gen, wind_gen, storage, cryst_load):
        self.thermal_load = self.P_req + cryst_load# kW
