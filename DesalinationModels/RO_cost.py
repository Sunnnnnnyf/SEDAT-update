...
import numpy as np
import math
from DesalinationModels.desalinationcosts import CR_factor


class RO_cost(object):
    def __init__(self,
                 Capacity = [50000], # Desalination plant capacity (m3/day)
...
#                 GOR = 10.475,  # Gained output ratio
                # downtime = 0.1, # Yearly downtime of the plant (ratio)
                 ...
                 int_rate = 0.025, # Average interest rate
